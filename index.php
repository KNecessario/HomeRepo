...
<html lang="en">
  ...
  <body>
    ...
    <!--Who we are-->
    <section class="container-fluid m-0 p-0" id="containerfluid3" id="section3">
      <div class="container  p-0" id="layout3">
        <div class="container" id="whatwebelieve"><h5>What we believe</h5></div>
        <div class="container" id="subwhatwebelieve">
          <h4>
            At the heart of our mission is the belief that businesses,
            regardless of their size, should have access to efficient and
            integrated solutions.
          </h4>
        </div>
        <div class="container m-0 p-0" id="wrapper1">
          <div class="container" id="leftWrap">
            <h1>Who we are?</h1>
            <p>
               Valenin IT Services is your dedicated partner for comprehensive
              IT software solutions, committed to transforming your business
              through technology. We specialize in providing tailored services
              to meet the unique needs of each business, from small enterprises
              to large corporations. Our team of experts ensures seamless
              operations, offering innovative solutions designed to drive your
              success and keep you ahead in a competitive market. At Valenin IT
              Services, we understand the critical role that IT infrastructure
              plays in your business, and we are here to support you every step
              of the way with our reliable, efficient, and cutting-edge
              services.
            </p>
          </div>
          <div class="container" id="rightWrap">
            <img src="image/whoweare.png" alt="Who we are" />
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- Our Mission -->
    <section class="container-fluid" id="containerfluid4" id="section4">
    ...
    <!-- Our Vision -->
    <!-- Our Vision -->
    <section class="container-fluid" id="containerfluid5" id="section5">
      <div class="container" id="layout5">
        <div class="container" id="wrapper3">
